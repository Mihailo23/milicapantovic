...
<?php
	...
	public function form( $instance ) {
		...
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'srbtranslatin' ); ?></label> 
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'cirilica_title' ); ?>"><?php _e( 'Cyrilic option title:', 'srbtranslatin' ); ?></label> 
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'latinica_title' ); ?>"><?php _e( 'Latin option title:', 'srbtranslatin' ); ?></label> 
		...
		<label for="<?php echo $this->get_field_id( 'selection_type' ); ?>"><?php _e( 'Selection type:', 'srbtranslatin' ); ?></label> 
