...
if( ! empty ($_POST['Reset']) ) {
 ?>
<div class="updated"><p><strong><?php _e('Options are reset to default values.', 'srbtranslatin'); ?></strong></p></div>
<?
}

if( ! empty ($_POST['Submit']) ) {
?>
<div class="updated"><p><strong><?php _e('Options are saved.', 'srbtranslatin'); ?></strong></p></div>
<?php
}
...
<tr>
<th scope="row"><?php _e("Transliterating files and URL-s:", 'srbtranslatin'); ?></th>
<td><input name="<?php echo $stl_skip_files_data_field_name; ?>" type="checkbox" <?php echo $stl_skip_files_opt_val==1 ? 'checked="checked"' : '' ?>> <?php _e("Do not transliterate file names and urls", 'srbtranslatin'); ?><br />
<?php echo __('Check to keep Cyrillic in file names and URL-s intact.', 'srbtranslatin'); ?>
</td>
</tr>
...
<input type="submit" name="Reset" value="<?php _e('Reset Options', 'srbtranslatin') ?>" />
</p>
